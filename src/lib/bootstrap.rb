...
def bootstrap()
  ...
  stream_cmd(sed('Arch Linux', 'Hobby Linux', '/mnt/etc/os-release'))
  stream_cmd(sed('Arch Linux', 'Hobby Linux', '/mnt/usr/lib/os-release'))
  stream_cmd(sed('# Misc options', 'ILoveCandy', '/mnt/etc/pacman.conf'))
